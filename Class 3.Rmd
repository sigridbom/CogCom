...
```{R}
`''
knitr::opts_knit$set(root.dir = "/Users/sigridnielsen/CogCom/Sarah_analysis/data/")
getwd()
...
```{R}
sarah_data_df <- map_df(sarah_work,function(x) read.CLAN.file(x))
getwd()
setwd("/Users/sigridnielsen/CogCom/Sarah_analysis/data/")
```
